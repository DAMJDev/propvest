...
const css = `
  ...
  *,*::before,*::after{box-sizing:border-box;margin:0;padding:0}
  ...
  .nl{color:rgba(245,242,236,0.85);font-size:32px;cursor:pointer;background:none;border:none;font-family:'DM Sans',sans-serif;font-weight:400;letter-spacing:0.5px;transition:color 0.2s;padding:0}
        ...
        <div className="hero" style={{ flexDirection:'row', alignItems:'stretch', padding:0, textAlign:'left' }}>
          ...
          <div style={{ flex:'0 0 50%', display:'flex', alignItems:'center', justifyContent:'center', padding:'60px 48px', borderRight:'1px solid rgba(201,168,76,0.1)' }}>
            <img src="/logo.png" alt="Prop Dev DNA"
              style={{ width:'100%', maxWidth:420, height:'auto', objectFit:'contain', mixBlendMode:'lighten', opacity:0.30 }}
